...
# glm-4-flash, not glm-4.7-flash: the latter's free pool returns HTTP 429
# (code 1305) for roughly 3 calls in 5, and being a reasoning model it can also
# answer 200 with an empty `content`. Both make this test flap for reasons that
# have nothing to do with the WCF path it exists to prove.
MODEL = os.environ.get("COW_TEST_GLM_MODEL", "glm-4-flash")
