...
class KnowledgeService:
    ...
    def build_graph(self) -> dict:
        ...
        for md_file in knowledge_path.rglob("*.md"):
            # as_posix, not str(): on Windows str() yields "concepts\a.md",
            # which the rel.split("/") below never splits - every node would
            # fall back to the "root" category - and which would not match a
            # link target written with forward slashes.
